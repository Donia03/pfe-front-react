  ...
  return (
    <div className="featured">
      <div className="featuredItem">
        <span className="featuredTitle">Nombre des Clients</span>
        <div className="featuredMoneyContainer">
          <span className="featuredMoney">{stats.clientNbr}</span>
        </div>
      </div>
      <div className="featuredItem">
        <span className="featuredTitle">Nombre des Prospects</span>
        <div className="featuredMoneyContainer">
          <span className="featuredMoney">{stats.prospectNbr}</span>
        </div>
      </div>
      <div className="featuredItem">
        <span className="featuredTitle">Nombre des Commandes</span>
        <div className="featuredMoneyContainer">
